...
export default function App() {
  return (
    <div style={{ width:'100vw', height:'100vh', position:'relative', background:'#050508' }}>
      <Suspense fallback={
      ...
      >
        <p style={{fontFamily:'Bebas Neue',fontSize:'11px',letterSpacing:'8px',color:'rgba(108,99,255,0.6)'}}>
